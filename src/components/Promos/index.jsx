      ...
      <div className="promo__first">
        <div className="promo__first__slide-box">
          <div
            ...
            style={{
              backgroundImage: 'url("/img/promo1.1.jpg")',
            }}
          >
          ...
          <div
            className="promo__first__slide-box__item"
            style={{
              backgroundImage: 'url("/img/promo1.2.jpg")',
            }}
          >
          ...
          <div
            className="promo__first__slide-box__item"
            style={{
              backgroundImage: 'url("/img/promo1.3.jpg")',
            }}
          >
      ...
      <div className="promo__second">
        <div className="promo__second__slide-box">
          <div
            ...
            style={{
              backgroundImage: 'url("/img/promo2.1.jpg")',
            }}
          >
          ...
          <div
            className="promo__second__slide-box__item"
            style={{
              backgroundImage: 'url("/img/promo2.2.jpg")',
            }}
          >
          ...
          <div
            className="promo__second__slide-box__item"
            style={{
              backgroundImage: 'url("/img/promo2.3.jpg")',
            }}
          >
